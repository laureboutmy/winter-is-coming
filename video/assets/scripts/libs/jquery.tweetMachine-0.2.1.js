        ...
        $(this).each(function () {
            ...
            if (this.tweetMachine) {
                ...
                settings = $.extend({
                    ...
                    limit:          20, // Number of tweets to display at a time
