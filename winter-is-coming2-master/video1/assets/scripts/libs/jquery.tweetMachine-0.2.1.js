		...
		$(this).each(function () {
			...
			if (this.tweetMachine) {
				...
				settings = $.extend({
					...
					tweetFormat: "<li class='tweet'><div class='meta'><img class='avatar' src=''/><a href='' class='username'></a><a href='' class='time'></a><div class='clear'></div></div><p class='tweet-content'></p><ul class='actions'><li><button class='reply'>REP</button></li><li><button class='retweet'>RT</button></li><li><button class='favorite'>FAV</button></li></ul></li>", // Format for each tweet
